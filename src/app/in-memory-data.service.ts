...
createDb(){
  ...
  const productsarray = [
    ...
    { id: 7, name: 'WazSUP neobit Up Paddle Boardooooooo', type: 'Outdoor Sports Equipment', status: 'In stock', price: 975.00, description: '10ft in length, 60/40 rails hybrid stand up board. Excellent in surf or flat water conditions.' },
