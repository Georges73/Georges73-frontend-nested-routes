...
export const PRODUCTS: Product[] = [
    { id: 1, name: 'Medavaciiiiiiiiiiiiiiiii Survival Kitaaan', type: 'Camping Gear', status: 'In stock', price: 14.99, description: 'Comes in a waterproof case. Includes fire starter, compass, wire saw, emergency whistle, can opener, suture thread and needle, bandages and more!' },
